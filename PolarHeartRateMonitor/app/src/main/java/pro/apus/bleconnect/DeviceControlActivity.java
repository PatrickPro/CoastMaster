...
public class DeviceControlActivity extends Activity {
    ...
    private final static String TAG = DeviceControlActivity.class
            .getSimpleName();
    final static private String APP_KEY = "YOUR_KEY"; 
    final static private String APP_SECRET = "YOUR_SECRET";
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                displayData(intent
                        ...
                        .getStringExtra(BluetoothLeService.EXTRA_RR_DATA));
    ...
    protected void onPause() {
        ...
        //unregisterReceiver(mGattUpdateReceiver); // THIS will stop the recording if screen is off!!!
    }
    ...
    private void displayData(String heartRate, String RRInterval) {
        try {
            if (heartRate != null) {
                ...
                int dataElement = Integer.parseInt(heartRate);
                ...
                if (currentlyVisible) {
                    mDataField.setText("Pulse: " + heartRate);
            ...
            Log.e(TAG, "Exception while parsing: " + heartRate + " - " + RRInterval);
        }
    }
